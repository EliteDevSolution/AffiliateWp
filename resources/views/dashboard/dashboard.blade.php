                ...
                <div class="col">
                    @if($enabledSocialList['facebook'])
                        <div class="card card-body bg-blue">
                            ...
                            <h4 class="text-white">{{ '@'.reset($enabledSocialList['facebook'])['social_id'] }}</h4>
                ...
                <div class="col">
                    @if($enabledSocialList['instagram'])
                        <div class="card card-body bg-blue">
                            ...
                            <h4 class="text-white">{{ '@'.reset($enabledSocialList['instagram'])['social_id'] }}</h4>
                            <div class="approved-image">
                                <img src="{{ asset("common_assets/icons/approved.svg") }}" height="30">
                            </div>
                ...
                <div class="col">
                    @if($enabledSocialList['tiktok'])
                        <div class="card card-body bg-blue">
                            ...
                            <h4 class="text-white">{{ '@'.reset($enabledSocialList['tiktok'])['social_id'] }}</h4>
                            <div class="approved-image">
                                <img src="{{ asset("common_assets/icons/approved.svg") }}" height="30">
                            </div>
                ...
                <div class="col">
                    @if($enabledSocialList['twitter'])
                        <div class="card card-body bg-blue">
                            ...
                            <h4 class="text-white">{{ '@'.reset($enabledSocialList['twitter'])['social_id'] }}</h4>
                            <div class="approved-image">
                                <img src="{{ asset("common_assets/icons/approved.svg") }}" height="30">
                            </div>
                ...
                <div class="col">
                    @if($enabledSocialList['linkedin'])
                        <div class="card card-body bg-blue">
                            ...
                            <h4 class="text-white">{{ '@'.reset($enabledSocialList['linkedin'])['social_id'] }}</h4>
                            <div class="approved-image">
                                <img src="{{ asset("common_assets/icons/approved.svg") }}" height="30">
                            </div>
